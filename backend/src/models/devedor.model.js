...
export default (sequelize, DataTypes) => {
  const Devedor = sequelize.define(
    "Devedor",
    {
      ...
      email_ultimo_envio_em: { type: DataTypes.DATE, allowNull: true },
      email_ultimo_status: { type: DataTypes.STRING, allowNull: true },
      recorrencia_grupo_id: { type: DataTypes.STRING, allowNull: true },
      recorrencia_tipo: { type: DataTypes.STRING, allowNull: false, defaultValue: "unica" },
      recorrencia_intervalo: { type: DataTypes.INTEGER, allowNull: true },
      recorrencia_unidade: { type: DataTypes.STRING, allowNull: true },
      recorrencia_data_personalizada: { type: DataTypes.DATE, allowNull: true },
      recorrencia_ate: { type: DataTypes.DATE, allowNull: true },
      recorrencia_status: { type: DataTypes.STRING, allowNull: false, defaultValue: "ativa" },
      recorrencia_ordem: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 1 },
    },
    {
      tableName: "devedores",
      timestamps: true,
