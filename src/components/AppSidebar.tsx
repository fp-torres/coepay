import { Home, BarChart3, Settings, Crown, Lightbulb, LogOut, CheckCircle2, MessagesSquare } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Comunicações", url: "/comunicacoes", icon: MessagesSquare },
